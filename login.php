...
<body class="flex items-center justify-center h-screen">
    ...
    <div class="w-full max-w-sm p-6 bg-white rounded-lg shadow-md">
        ...
        <form action="login_db.php" method="post">
            ...
            <div class="mb-4">
                <label for="email" class="block text-sm font-medium text-gray-700"style="font-family: 'Kanit', sans-serif;">Email</label>
            ...
            <div class="mb-4 relative">
                <label for="password" class="block text-sm font-medium text-gray-700"style="font-family: 'Kanit', sans-serif;">Password</label>
                <div class="relative">
            ...
            <div class="text-sm text-gray-600 mt-3">
                <p>หากยังไม่ได้ยืนยันอีเมลล์<a href="approval.php" class="text-blue-500 hover:underline"style="font-family: 'Kanit', sans-serif;">  ตรวจสอบสถานะ</a></p>
            </div>
            
            <button type="submit" name="login_user" 
                    class="w-full bg-gradient-to-r from-[#2B547E] to-[#29465B] text-white text-lg rounded-lg shadow-lg transform hover:scale-105 hover:shadow-2xl transition duration-300 font-medium py-2 px-4 rounded-lg shadow-sm mt-3"
                    style="font-family: 'Kanit', sans-serif;">
                เข้าสู่ระบบ
            </button>
            
            <div class="text-sm text-gray-600 mt-3">
                <p>หากยังไม่ได้ลงทะเบียน <a href="register.php" class="text-blue-500 hover:underline"style="font-family: 'Kanit', sans-serif;">สร้างบัญชี</a></p>
            </div>
        </form>
    </div>
