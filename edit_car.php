        ...
        <div class="overflow-x-auto">
            <table id="carInfoTable" class="min-w-full bg-white shadow-md rounded-lg">
                ...
                <tbody class="text-gray-600 text-sm font-light">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="8" class="py-4 text-center text-gray-500">ไม่มีข้อมูลรถในระบบ</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
    ...
    <div id="editModal" class="modal hidden fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center">
        <div class="bg-white p-6 rounded-lg w-96">
            ...
            <form action="update_car.php" method="post" onsubmit="return validateForm()">
                ...
                <label class="block text-gray-700">เลขทะเบียนรถ</label>
                ...
                <label class="block text-gray-700">ประเภทรถ</label>
                ...
                <label class="block text-gray-700">ยี่ห้อรถ</label>
                ...
                <label class="block text-gray-700">ยอดชำระค่าปรับ</label>
                ...
                <label class="block text-gray-700">อุปกรณ์</label>
                ...
                <label class="block text-gray-700">รหัสปลดล็อก</label>
                ...
                <div class="mt-4">
                    <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">บันทึก</button>
