...
<body class="bg-gray-100" style="font-family: 'Kanit', sans-serif;">
    <header class="bg-gradient-to-r from-[#2B547E] to-[#29465B] text-white shadow-lg">
        <div class="container mx-auto px-4 py-6 flex items-center justify-between">
            ...
            <h1 class="text-xl" style="font-family: 'Kanit', sans-serif; font-size: 16px;">สรุปยอดชำระค่าปรับรายเดือน</h1>
    ...
    <div id="left-menu" class="fixed top-0 left-0 w-64 h-full bg-white shadow-lg z-50">
        ...
        <nav class="p-4">
            <ul>
                ...
                <li><a href="chack_device.php" class="block py-2 px-4 text-gray-700 hover:bg-gray-200" style="font-family: 'Kanit', sans-serif;">ตรวจเช็คอุปกรณ์</a></li>
            </ul>
        </nav>
    </div>
    <div class="min-h-screen bg-gray-100 text-gray-900 p-4" style="font-family: 'Kanit', sans-serif;">
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <form method="get" action="" class="mb-8" style="font-family: 'Kanit', sans-serif;">
            ...
            <p class="text-center text-gray-600 mb-8" style="font-family: 'Kanit', sans-serif;">
