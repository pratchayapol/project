        ...
        <div id="modal-content">
            ...
            <div class="flex flex-col space-y-8">
                ...
                <div class="bg-gray-50 p-6 rounded-lg shadow-md border border-gray-300">
                    <h3 class="text-2xl text-gray-700 mb-4"style="font-family: 'Kanit', sans-serif;">ข้อผู้ชำระค่าปรับ</h3>
            ...
            <script>
                ...
                document.getElementById('closeModal').addEventListener('click', function() {
                    window.location.href = 'show_user_db.php';  // Redirect to the main page
                });
            </script>
